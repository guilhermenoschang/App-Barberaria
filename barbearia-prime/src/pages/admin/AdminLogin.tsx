  ...
  return (
    <div data-theme={theme} style={{ minHeight: '100vh', background: 'var(--bg0)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div className="card card-gold" style={{ padding: 36, width: '100%', maxWidth: 380 }}>
        ...
        <div className="mock-banner" style={{ width: '100%', justifyContent: 'center', marginBottom: 20 }}>
          ⚠ MVP — autenticação simulada
        </div>
        ...
        <button className="btn-gold" style={{ width: '100%', justifyContent: 'center', gap: 8 }} onClick={handle}>
          <Lock size={14} /> Acessar Painel
        </button>
