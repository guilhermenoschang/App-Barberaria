    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {mobileOpen && (
        <div style={{
          ...
          {sessionUser && <button onClick={() => { logout(); setMobileOpen(false) }} style={{ background: 'none', border: 'none', color: 'var(--t3)', cursor: 'pointer', padding: '10px 0', fontSize: 13 }}>Sair</button>}
        </div>
      )}
